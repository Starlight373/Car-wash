...
3. **Customers Page** - Add, Edit, Delete + View transaction history
4. **Memberships Page** - Create, View Detail, Extend, Delete
5. **User Management** - Add users, Edit info, Reset password

### Phase 3 - Enhanced POS ✅ COMPLETED
1. **Jual Produk Fisik** - Tab Produk di POS
2. **Member Subscription Flow** - Cek member → Gratis cuci → Dicatat di transaksi
...
- MongoDB collections: users, customers, memberships, inventory, services, products, transactions, shifts
...
## User Personas
1. **Owner** - Full access, manage users, view all reports
2. **Manager** - Manage operations, cannot delete users
...
- [x] Member subscription check flow
- [x] Shift management
...
- [x] User management (add, edit, reset password)
